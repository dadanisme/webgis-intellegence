...
export default function Login() {
  ...
  return (
    <div className="flex items-center justify-center h-screen px-16 gap-12">
      <aside className="relative w-full h-[300px] flex items-center">
      ...
      <aside className={clsx("relative", "flex items-center justify-center")}>
        <main className="pt-12 pb-20 px-10 shadow-2xl w-[455px] rounded-xl bg-white">
          ...
          <form className="mt-8 flex flex-col gap-3" ref={formRef}>
            ...
            <div className="flex items-center justify-between">
              <Link
                to="/auth/register"
                className="text-[#C7C7C7] text-sm font-semibold"
              >
                Register
              </Link>
              <Link
